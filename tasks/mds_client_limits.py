...
class TestClientLimits(CephFSTestCase):
    ...
    def _test_client_pin(self, subdir):
        """
        ...
        :param subdir: whether to put test files in a subdir or use root
        """
        ...
        path = "subdir/mount_a" if subdir else "mount_a"
        ...
        self.wait_for_health("failing to relinquish capabilities", mds_recall_state_timeout + 10)
